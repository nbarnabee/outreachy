...
/*  showSearch causes the search bar container to be displayed, hides the 
start buttons, and creates a "back" button */
...
/* showSuggestions accepts the array returned by buildSuggestionsMenu, creates list items for each object 
in the array, appends them to the suggestions <ul>, and gives the <ul> a new class
...
/* useSuggestion sets the value of the searchBar to be equal to the value of the "data-value" attribute of 
the event target (the list element generated by makeListElement)  */
